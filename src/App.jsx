          ...
          <section className="card">
            <div className="menu-left">
              ...
              <ul className="products-list" id="products-list">
                {data &&
                  data.data.map((item) => {
                    const inBasket = product.basket.find(
                      (i) => i.id === item.id
                    );
                    ...
                    return (
                      <li
                        key={item.id}
                        className={`product-item ${inBasket ? "active" : ""}`}
                      >
                          ...
                          {inBasket ? (
                            <div className="add-to-cart-btn active">
                              <button
                                ...
                                onClick={() =>
                                  inBasket.count > 1
                                    ? dispatch(delProductCount(inBasket.id))
                                    : dispatch(delProduct(inBasket.id))
                                }
                              ...
                              <span className="quantity">{inBasket.count}</span>
                              <button
                                className="quantity-btn"
                                onClick={() =>
              ...
              {product.basket.length === 0 ? (
                ...
                <div className="cart-content">
                  <div className="cart-items">
                    {product.basket.map((cartProduct) => (
                      <div key={cartProduct.id} className="cart-item">
                        ...
                        <button
                          ...
                          aria-label={`Remove ${cartProduct.name} from cart`}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="10"
                  ...
                  <div className="carbon-neutral">
                    ...
                    <p className="carbon-neutral-title">
                      This is a carbon-neutra delivery
                    </p>
                  </div>
